...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    //                putDataMapReq.getDataMap().putDouble("HIGH_TEMP", 2);
    //                Log.d("TEMPPPPPPPPPP", String.valueOf(1));
    //
    //                putDataMapReq.getDataMap().putDouble("LOW_TEMP", 2);
    //                putDataMapReq.getDataMap().putInt("ID", 1);
    //                PutDataRequest putDataReq = putDataMapReq.asPutDataRequest();
    //                putDataReq.setUrgent();
    //                DataApi.DataItemResult result = Wearable.DataApi.putDataItem(googleApiClient, putDataReq).await();
    //                Log.d("reeeeeeeeeeeeeeeeeeeee", String.valueOf(result.getStatus().isSuccess()));
    //
    //            }
    //        };
    //        sendToDL.start();
