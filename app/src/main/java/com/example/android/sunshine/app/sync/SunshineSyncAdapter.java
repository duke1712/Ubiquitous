...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        public void run() {
            ...
            putDataMapReq.getDataMap().putDouble("HIGH_TEMP", mHigh);
            Log.d("TEMper", String.valueOf(1));

            putDataMapReq.getDataMap().putDouble("LOW_TEMP", mLow);
        String graphic="";
        if (id >= 200 && id <= 232) {
            graphic= "storm";
            ...
            putDataMapReq.getDataMap().putString("ID", graphic);
            PutDataRequest putDataReq = putDataMapReq.asPutDataRequest();
            putDataReq.setUrgent();
            DataApi.DataItemResult result = Wearable.DataApi.putDataItem(googleApiClient, putDataReq).await();
            Log.d("reeeeeeeeeeeeeeeeeeplr", String.valueOf(result.getStatus().isSuccess()));
...
//        Log.d("TEMPPPPPPPPPP", String.valueOf(high));
//
